"""
 ...
 @Email: xxx@xxx.com
 @FileName: Table.py
 @DateTime: 2023/9/26 16:29
 @SoftWare: PyCharm
"""
import os
from jinja2 import Environment, FileSystemLoader

from utils.handle_quote import qtIdent, qtLiteral
...
# 拼接模板文件目录
template_path = os.path.join(root_path, 'Table')
...
env.globals['qtLiteral'] = qtLiteral


# 'columns': [{'name': 'c1', 'cltype': 'int', 'nullable': False, 'default': '1', 'comment': 'c1'},
